#
#  Be sure to run `pod spec lint BMLayoutConstraint.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "BMLayoutConstraint is a UI layout adaptation tool."
  ...
  s.author             = { "beichenming" => "beichenming@163.com" }
  # Or just: s.author    = "beichenming"
  # s.authors            = { "beichenming" => "beichenming@163.com" }
  # s.social_media_url   = "http://twitter.com/beichenming"
  ...
  s.source       = { :git => "https://github.com/beichenming/BMLayoutConstraint.git", :tag => "1.0.0" }
